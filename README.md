...
Det er fordi, at metoden som ses nedenstående kun kaldte til horizontal, da den kun kaldte på 0. Dette kunne man se, når vi evaluerede på det, at vertikalt aldrig blev kaldt. 
...
Ved evaluate kun man se, at når programmet kørte hver gang, så ændrede det mellem 0 og 1. 
    
2. Why do we never get message *Ship sunk!* when log output shows 3 direct hits?
   
Problemet her er, at isSunk() metoden altid var 0. Og det vil sige, at det blev aldrig registret når et skib blev ramt. Derfor lavede jeg en conditional breakpoint i metoden for at pausere eller stoppe spillet, når et skib bliver ramt 3 gange. Jeg tilføjede  hitCount == 3 til conditional breakpoint. 
...
De teknikker jeg anvendte her: 
- En ny breakpoint
- Tilføjer hitCount == 3 til metoden vha. conditional breakpoint. 
...
Jeg kørte debugger adskillige gange indtil jeg så exceptionen i addBattleship() metoden. Her kunne jeg se, at x = 9 & y = 10. 10 er over indeksen, da indeksen er 0-9. Derfor meldes fejlen også. Der bliver brugt en indeks, der ligger uden for arraysets grænser. 
